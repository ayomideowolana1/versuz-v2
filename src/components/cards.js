        ...
        <div className="onevone card-cont">
          <div className="card-main paired border">
            ...
            <div className="center ">
              ...
              <span>{data.number_of_wins} - {data.opponent[0].number_of_wins}</span>
              <img className="userIcon" src={userIcon} alt="" />
            </div>
            <div className="bottom">
              <div className="amount">
                <span className="value"><CountdownTimer date={data.end_date} /></span>
          ...
          <div className="bottom">
            <div className="amount">
              ...
              <div className="button" >
                {(userCard && <button>REVIEW</button>) || <button onClick={pair}>JOIN </button>}
              </div>
